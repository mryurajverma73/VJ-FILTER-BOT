...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002270591284')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002461283565')).split()]  # For Multiple Id Use One Space Between Each.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/e8ae0b075676a82219dd9-6f016475754f166931.jpg') # payment code picture url.
...
CUSTOM_FILE_CAPTION = environ.get("ᎷᎧᏂᎥᏖ࿐Owner", f"{script.CAPTION}")
BATCH_FILE_CAPTION = environ.get("ᎷᎧᏂᎥᏖ࿐Owner", CUSTOM_FILE_CAPTION)
