...
# Bot information
SESSION = environ.get('SESSION', 'MohitBot')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002313753067'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002485070941').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002270591284') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002270591284')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '2044702863')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002485070941')).split()]  # For Multiple Id Use One Space Between Each.
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Vermacollection')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+vEXW5lfSc3k4YmM1')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '52962250962b49a8e51a75687f2a16a7b0775c1e')
...
MSG_ALRT = environ.get('MSG_ALRT', '𝐻𝑒𝓁𝓁𝑜 𝑀𝓎 𝒟𝑒𝒶𝓇 𝐹𝓇𝒾𝑒𝓃𝒹𝓈 ❤️')
...
LANGUAGES = ["malayalam", "mal", "punjabi", "pun" ,"english", "eng", "hindi", "hin", "daul", "telugu", "tel", "kannada", "kan"]
SEASONS = ["s01", "s02", "season 3", "season 4", "season 5", "season 6", "season 7", "season 8", "season 9", "season 10"]
EPISODES = ["E01", "E02", "E03", "E04", "E05", "E06", "E07", "E08", "E09", "E10", "E11", "E12", "E13", "E14", "E15", "E16", "E17", "E18", "E19", "E20", "E21", "E22", "E23", "E24", "E25", "E26", "E27", "E28", "E29", "E30", "E31", "E32", "E33", "E34", "E35", "E36", "E37", "E38", "E39", "E40"]
QUALITIES = ["360p", "480p", "720p", "1080p", "1440p", "2160p"]
YEARS = ["1900", "1991", "1992", "1993", "1994", "1995", "1996", "1997", "1998", "1999", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025"]
STORY = ["horror", "comedy", "drama", "hiest", "space"]
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = True
URL = environ.get("URL", "https://parallel-krystle-dasiitinstitte-86b8e23c.koyeb.app/")
