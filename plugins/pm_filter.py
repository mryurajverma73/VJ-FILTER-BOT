...
async def filter_yearss_cb_handler(client: Client, query: CallbackQuery):
    ...
    try:
        if int(req) not in [query.message.reply_to_message.from_user.id, 0]:
            return await query.answer(
                f"⚠️ ʜᴇʟʟᴏ{query.from_user.first_name},\nᴛʜɪꜱ ɪꜱ ɴᴏᴛ ʏᴏᴜʀ ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ,\nʀᴇQᴜᴇꜱᴛ ʏᴏᴜʀ'ꜱ, ये Movie आपने Search नहीं की है आप अपनी Search करो...",
                show_alert=True,
            )
    except:
        pass
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @kingvj01
        ...
        btn = [[
            ...
            InlineKeyboardButton("Hindi", callback_data="hindi_info""dual_info""hin_info")
        ],[
    ...
    elif query.data == "hindi_info" "dual_info" "hin_info":
        btn = [[
